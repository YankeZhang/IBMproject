...
import {UniversitydetailComponent} from './DemoPages/Dashboards/universitydetail/universitydetail.component';
// Applications
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'dashboards/university', component: UniversityComponent, data: {extraParameter: 'dashboardsMenu'}},
      {path: 'dashboards/requests', component: RequestsComponent, data: {extraParameter: 'dashboardsMenu'}},
      {path: 'dashboards/universitydetail', component: UniversitydetailComponent, data: {extraParameter: 'dashboardsMenu'}},
